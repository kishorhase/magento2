<?php
namespace Inchoo\Blog\Block\Adminhtml\Post;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Inchoo_Blog';
        $this->_controller = 'adminhtml_post';

        parent::_construct();

        if ($this->_isAllowedAction('Inchoo_Blog::save')) {
        ...
        if ($this->_isAllowedAction('Inchoo_Blog::post_delete')) {
