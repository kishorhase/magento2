...
class Post extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    \Magento\Framework\App\Helper\Context $context, \Inchoo\Blog\Model\Post $post, \Magento\Framework\View\Result\PageFactory $resultPageFactory
    ) {
        $this->_post = $post;
    ...
    public function prepareResultPost(Action $action, $postId = null) {
        ...
        $this->_eventManager->dispatch(
                'inchoo_blog_post_render', ['post' => $this->_post, 'controller_action' => $action]
        );
