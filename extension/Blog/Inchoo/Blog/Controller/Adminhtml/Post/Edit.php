...
namespace Inchoo\Blog\Controller\Adminhtml\Post;
...
class Edit extends \Magento\Backend\App\Action {
    ...
    protected function _isAllowed() {
        return $this->_authorization->isAllowed('Inchoo_Blog::save');
    }
    ...
    protected function _initAction() {
        ...
        $resultPage->setActiveMenu('Inchoo_blog::post')
    ...
    public function execute() {
        ...
        $model = $this->_objectManager->create('Inchoo\Blog\Model\Post');
